...
const createEvents = data => {
  ...
  events.forEach(event => {
    ...
    eventLink.setAttribute("href", "events-specific.html?id=" + event.id)
...
// TODO: make possible to load in more than the inital 20 events.
// TODO: add more details for each event and display to the DOM.
// TODO: Style the elements
// TODO: Add unique url for each event to display more info.
